 ...
 * CRC:
 * 
 * The DistanceSensor will be implemented by a BasicSensor Class. 
 * The sensor will be referred to by the robot, and will recieve the robot's current maze configuration through the robots reference to the controller.
 * Thus, the sensor class will recieve a reference to the controller through the robot. There are four different types of sensors, each of which can be added to the robot through the robot method addDistanceSensor.
 * 
 *
 */
public interface DistanceSensor {
	...
	int distanceToObstacle(int[] currentPosition, 
			CardinalDirection currentDirection) throws Exception;
