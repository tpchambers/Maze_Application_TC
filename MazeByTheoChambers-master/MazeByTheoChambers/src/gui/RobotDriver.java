 ...
 *CRC:
 *
 *The RobotDriver interface is implemented by WallFollower and Wizard.
 *Here, the RobotDriver will deploy the strategy and will use the Robot object to have a reference to the current maze with the robots sensors.
 *The RobotDriver thus refers to the Robot object, in order to make use of the sensors that the Robot object refers to. We use the RobotDriver to drive the robot around the maze and will use a WallFollower strategy to perform this operation. 
 */
